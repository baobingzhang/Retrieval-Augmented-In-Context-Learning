...
from tabpfn_lib.architectures.base.bar_distribution import FullSupportBarDistribution

# --- TabPFN imports ---
from tabpfn_lib.constants import (
...
from tabpfn_lib.inference import (
    InferenceEngine,
...
from tabpfn_lib.model_loading import load_model_criterion_config, resolve_model_version
from tabpfn_lib.preprocessing import (
    BaseDatasetConfig,
    ClassifierDatasetConfig,
    DatasetCollectionWithPreprocessing,
    RegressorDatasetConfig,
)
from tabpfn_lib.settings import settings
from tabpfn_lib.utils import (
    infer_devices,
...
if TYPE_CHECKING:
    ...
    from tabpfn_lib.architectures.base.bar_distribution import FullSupportBarDistribution
    from tabpfn_lib.architectures.interface import Architecture, ArchitectureConfig
    from tabpfn_lib.classifier import TabPFNClassifier
    from tabpfn_lib.inference_config import InferenceConfig
